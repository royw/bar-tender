...
We are going to use Sequel to initially connect to sqlite3 file database, then eventually move to a postgres database.
...
And finally into our service controller.
