...
I'm tasked with replacing a java/hibernate/postgres server with a silverlight UI application with a web 2.0 application.
This is for a small company that is not a Rails shop.  We decided on a ruby/ramaze/sequel/postgres server with
