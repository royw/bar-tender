...
A very flexible authentication rack plugin is omniauth.  There is an ldap plugin for omniauth.  I have not yet found
a certificate plugin for it, but there is password based plugins.
